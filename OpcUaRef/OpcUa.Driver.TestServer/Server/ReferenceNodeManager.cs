	...
	public override void CreateAddressSpace(IDictionary<NodeId, IList<IReference>> externalReferences)
	{
		lock (Lock)
		{
			...
			try
			{
				...
				sendDownlinkRequest.InputArguments.NodeId = new NodeId(sendDownlinkRequest.BrowseName.Name + "InArgs", NamespaceIndex);
				...
				sendDownlinkRequest.OutputArguments.NodeId = new NodeId(sendDownlinkRequest.BrowseName.Name + "OutArgs", NamespaceIndex);
				...
				sendDownlinkRequest.OnCallMethod = new GenericMethodCalledEventHandler(OnMultiplyCall);
			}
			catch (Exception e)
			{
